...
//                distribution.
//
// Version 1.19:  Added internal function for factory use only.
// 
// Version 1.20:  Fixed a subtle mutex problem in the OpenLabJack and ListAll
//				  functions which caused occasional problems with 
//				  multi-threaded applications.
//
// Version 1.21:  Fixed a small bug that would cause multiple handles to be
//				  created
//----------------------------------------------------------------------
//
...
//======================================================================
//ThreadTest:	Simply creates a thread which exits right after doing nothing.
//----------------------------------------------------------------------
long _stdcall ThreadTest(long timeoutms);
...
//======================================================================
// LJHash: Hashing function used internally.
//
//	Returns:	LabJack errorcodes or 0 for no error (I32).
//	Inputs:		*inBuffer	-Input buffer (U8).
//				size		-Size of input buffer (I32).
//				mode		-Reserved for future use (I32).
//	Outputs:	*outBuffer	-16 byte array used to hold output (U8).
//
//	Time:		10 ms
//----------------------------------------------------------------------
//long _stdcall LJHash(unsigned char *inBuffer, 
//					 long size, 
