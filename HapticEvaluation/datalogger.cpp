...
void DataLogger::WritePacket(Vector3 &dataPack, QString element)
{
	...
	xml.writeTextElement("X"+element,QString::number(dataPack.x,'f',3));
	xml.writeTextElement("Y"+element,QString::number(dataPack.y,'f',3));
	xml.writeTextElement("Z"+element,QString::number(dataPack.z,'f',3));
